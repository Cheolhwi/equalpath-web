...
- The user additionally requested a RhineLab-inspired landing page with Gaussian blur and a GTA-style zoom-out/pan/zoom-in entrance on 2026-09-12. Preserve the same mounted flat map, skip/reduced-motion controls, and in-memory request/comparison state when returning home. No automatic geolocation on the landing page.
