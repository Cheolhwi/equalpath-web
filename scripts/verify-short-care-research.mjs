...
const out=resolve(import.meta.dirname,'../../webapp-data/source/short-care-100-20260915');
...
const updatedId='provider_6608d9c70e9c6ad94b4600b1e22';
...
assert.equal(after.items.filter(p=>p.admission.value===true).length,21);
...
writeFileSync(resolve(import.meta.dirname,'../evidence/short-care-research-publication.json'),JSON.stringify(result,null,2));
